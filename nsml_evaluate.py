        ...
        for pred in prelim_predictions:
            try:
                ...
                if pred.start_index > 0:  # this is a non-null prediction
                    ...
                    #tok_text = "".join(tokenizer.convert_ids_to_tokens(tok_tokens))
                    ...
                    #final_text = tok_text
                    #print(tok_text, orig_text, final_text)
                ...
                print("[for pred in prelim_predictions]Error : {}".format(str(e)))
                continue
        ...
        for qas_id, nbest_json in all_nbest_json.items():
            ...
            if qa_id_without_s not in best_answer_max_prob:
                ...
                if is_max_prob_updated:
                    best_answer_max_prob[qa_id_without_s] = prob
                    best_answer_text[qa_id_without_s] = text
        qid_and_answers = [("test-{}".format(qid), answer) for qid, (_, answer) in enumerate(best_answer_text.items())]
        return all_predictions, qid_and_answers
